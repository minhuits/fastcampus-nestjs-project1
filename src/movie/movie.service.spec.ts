...
describe('MovieService', () => {
  ...
  describe('findAll', () => {
    ...
    it('should return a list of movies without user likes', async () => {
      ...
      jest.spyOn(commonService, 'applyCursorPagination').mockResolvedValue({ nextCursor: null } as any);
      ...
      expect(commonService.applyCursorPagination).toHaveBeenCalledWith(qb, dto);
    ...
    it('should return a list of movies with user likes', async () => {
      ...
      getMoviesMock.mockResolvedValue(qb);
      jest.spyOn(commonService, 'applyCursorPagination').mockReturnValue({ nextCursor: null } as any);
    ...
    it('should return movies without title filter', async () => {
      ...
      getMoviesMock.mockResolvedValue(qb);
      jest.spyOn(commonService, 'applyCursorPagination').mockResolvedValue({
        nextCursor: null,
      } as any);
  ...
  describe('create', () => {
    ...
    beforeEach(() => {
      ...
      renameMovieFileMock = jest.spyOn(movieService, 'createRenameMovieFile');
    });
    ...
    it('should create a movie successfully', async () => {
      ...
      (queryRunner.manager.findOne as any).mockResolvedValueOnce({ ...createMovieDto, id: 1 });
      ...
      const result = await movieService.create(createMovieDto, userId, queryRunner);
      ...
      expect(createMovieDetailMock).toHaveBeenCalledWith(queryRunner, createMovieDto);
      ...
      expect(createMovieGenreRelationMock).toHaveBeenCalledWith(queryRunner, movieInsertResult.identifiers[0].id, genres);
    ...
    it('should throw NotFoundException if director does not exist', async () => {
      ...
      await expect(movieService.create(createMovieDto, userId, queryRunner)).rejects.toThrow(NotFoundException);
      expect(queryRunner.manager.findOne).toHaveBeenCalledWith(Director, {
        where: {
          id: createMovieDto.directorId,
        }
  ...
  describe('update', () => {
    ...
    it('should update a movie successfully', async () => {
      ...
      expect(queryRunner.manager.find).toHaveBeenCalledWith(Genre, {
        where: {
          id: In(updateMovieDto.genreIds as number[]),
        },
      });
      expect(updateMovieMock).toHaveBeenCalledWith(queryRunner, expect.any(Object), 1);
      expect(updateMovieDetailMock).toHaveBeenCalledWith(queryRunner, updateMovieDto.detail, movie);
      expect(updateMovieGenreRelationMock).toHaveBeenCalledWith(queryRunner, 1, genres, movie);
    ...
    it('should throw NotFoundException if movie does not exist', async () => {
      ...
      (queryRunner.manager.findOne as any).mockResolvedValue(null);
    ...
    it('should throw NotFoundException if new genres do not exist', async () => {
      ...
      (queryRunner.manager.findOne as any).mockResolvedValueOnce(movie);
      (queryRunner.manager.find as any).mockResolvedValueOnce([{ id: 1, name: 'Genre1' }]);
      ...
      expect(queryRunner.manager.find).toHaveBeenCalledWith(Genre, {
        where: {
          id: In(updateMoviesDto.genreIds as number[])
        }
      });
      expect(queryRunner.rollbackTransaction).toHaveBeenCalled();
    });
    ...
    it('should rollback transaction and rethrow error on failure', async () => {
      ...
      (queryRunner.manager.findOne as any).mockRejectedValueOnce(new Error('Database Error'));
